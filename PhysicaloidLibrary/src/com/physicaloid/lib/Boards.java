...
public enum Boards {
    ...
    ARDUINO_NANO_328_OLD_BOOTLOADER(0, "na32ob", ChipTypes.M328P, UploadProtocols.STK500, 57600, ComProtocols.UART, "Arduino Nano ATmega328 (Old Bootloader)"),
    ARDUINO_NANO_328_NEW_BOOTLOADER(1, "na32nb", ChipTypes.M328P, UploadProtocols.STK500, 115200, ComProtocols.UART, "Arduino Nano ATmega328 (New Bootloader)"),
